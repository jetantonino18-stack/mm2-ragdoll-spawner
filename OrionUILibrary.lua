-- ===== ORION UI LIBRARY - COMPLETE IMPLEMENTATION =====
-- A modern, Orion-inspired UI library with smooth animations and full API support
...
function OrionLib:CreateWindow(config)
	...
	-- Window corner roundness (using UICorner)
